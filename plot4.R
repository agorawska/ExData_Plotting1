...
#setting 'canvas' for 4 plots - 2 plots in each of 2 rows - filling column-wise
par(mfcol=c(2,2),mar=c(5,5,3,3))

#first plot
plot(datetime, as.numeric(energyData$Global_active_power), xlab="", ylab="Global Active Power", type="l")
...
#third plot
plot(datetime,as.numeric(energyData$Voltage),xlab="datetime", ylab="Voltage",type="l")

#fourth plot
plot(datetime,as.numeric(energyData$Global_reactive_power),xlab="datetime", ylab="Global_reactive_power",type="l")
